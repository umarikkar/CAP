...
class Single_cell_centered(torch.nn.Module):
    ...
    def forward(self, img):
        ...
        new_img = np.pad(new_img, ((upper_pad, lower_pad), (left_pad, right_pad), (0, 0)), "constant").transpose(1, 2, 0)
        ...
        padded_img = np.pad(new_img, ((upper_pad, lower_pad), (left_pad, right_pad), (0, 0)), "constant")
